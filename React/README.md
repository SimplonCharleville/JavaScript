...
**/!\ On va utiliser l'invite de commande, ne vous perdez pas dans vos répertoires ! (installation/projet)**
...
* Modifiez le titre (Hello World), remplacez le logo par un picto FontAwesome (spinner icon animé)
